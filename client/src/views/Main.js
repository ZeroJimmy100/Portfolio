            ...
            <div>
                ...
                <div id="Links">
                    ...
                    <div className="ResumeBorder">
                        <a href="https://drive.google.com/file/d/1_NYUOFyTJeFLxf_uJbaBd-XllrbQOsCb/view?usp=sharing" target="_blank" rel="noopener noreferrer"> <img className="Resume" src={ require("../components/css/resume.png")} alt=""/> </a>
                    </div>
